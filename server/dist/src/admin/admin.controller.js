...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Execute raw SQL (Admin only)' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], AdminController.prototype, "executeSql", null);
__decorate([
    (0, common_1.Get)('tables'),
    (0, roles_decorator_1.Roles)('ADMIN'),
    (0, swagger_1.ApiOperation)({ summary: 'List database tables (Admin only)' }),
    __metadata("design:type", Function),
